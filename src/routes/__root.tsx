...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/RRGJCGseFRODbxlsolTf53VGwZG3/social-images/social-1784728101079-D64EE766-CB6B-433E-A2A7-2DDD761716E2.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/RRGJCGseFRODbxlsolTf53VGwZG3/social-images/social-1784728101079-D64EE766-CB6B-433E-A2A7-2DDD761716E2.webp" },
    ],
    links: [
